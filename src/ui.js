...
// 小面板的 HTML 结构
const panelHtml = `
  <div id="custom-panel" style="position: fixed; top: 20px; right: 20px; width: 630px; height: 80vh; background: rgba(128, 128, 128, 0.6); color: black; padding: 15px; border-radius: 10px; z-index: 9999; box-shadow: 0 4px 6px rgba(0,0,0,0.3); display: flex; flex-direction: column;">
    ...
    <div id="panel-content" style="flex: 1; display: flex; flex-direction: column; overflow: hidden;">
      ...
      <div id="pattern-container" style="flex: 1; overflow-y: auto; background: rgba(255,255,255,0.03); padding: 5px; border-radius: 5px;"></div>
    </div>
  </div>
`;
